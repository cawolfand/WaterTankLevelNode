...
void setup() {
  ...
  Serial.println();
  Serial.println("Starting GatewayWemoRfm915MHZRev2_MQTT.ino");
  delay(10);
  //EEPROM.begin(512);
...
if (radio.DATALEN != sizeof(Payload))
{
      ...
      Serial.print(radio.DATALEN); Serial.print(" / "); Serial.println(sizeof(Payload));
       Serial.print(" nodeId=");
      ...
      Serial.print(theData.sensorData2);
       Serial.print(" sensor3=");
      Serial.print(theData.sensorData3);
       Serial.print(" sensor4=");
      Serial.print(theData.sensorData4);
       Serial.print(" sensor5=");
      Serial.print(theData.sensorData5);
   ...
   else  
   {
    ...
    if (radio.ACKRequested())
    {
      ...
      Serial.flush();
 //     sendEmail(message);
       Serial.print(" end loop ");Serial.println(loopcount++);
  }else {
      radio.receiveDone(); //put radio in RX mode
  }   
  //Serial.print(".");
